  ...
  const handleDelete = async () => {
    try {
      ...
      if (result.isConfirmed) {
        ...
        // Example: await deleteProduct(productId);
        // Replace deleteProduct(productId) with your actual delete operation
        ...
        <div className="max-w-full overflow-x-scroll scroll-bar-none">
          <div className=" flex flex-col min-w-[55rem]">
            <div className=" grid grid-cols-12 text-sm font-semibold px-5 py-3 bg-secondary/70 text-white shadow-lg rounded-t-md">
              ...
              <div className="col-span-3 text-center">Product Description</div>
              ...
              {manageProducts?.map((data, i) => (
                ...
                >
                  ...
                  <div className="col-span-1 flex gap-1">
                    <p className="p-2 rounded-md bg-whatsapp/10 text-whatsapp cursor-pointer ">
                      <CiEdit />
                    </p>
                    <p
